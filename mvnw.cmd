...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    powershell -Command "&{"^
		...
		"}"^
		"[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; $webclient.DownloadFile('%MVNW_REPOURL%/org/apache/maven/wrapper/maven-wrapper/3.2.0/maven-wrapper-3.2.0.jar', '%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar')"^
		"}"
    if "%MVNW_VERBOSE%" == "true" (
...
if "%ERROR_CODE%"=="0" goto endWithSuccess

echo.
echo ERROR: Maven execution failed with code %ERROR_CODE%
echo.
exit /b %ERROR_CODE%
